...
fn main() {
    ...
    let product_id = user_toml.get_device_config().product_id;
    let constants = get_constants_str(user_toml.rmk, product_id);
...
fn get_constants_str(constants: RmkConstantsConfig, product_id: u16) -> String {
    ...
    [
        ...
        const_declaration!(pub(crate) SPLIT_PRODUCT_ID = product_id),
