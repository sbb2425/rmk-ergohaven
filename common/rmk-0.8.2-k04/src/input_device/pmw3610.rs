    ...
    MOTION: InputPin,
{
    ...
    /// Wait until the PMW3610 motion GPIO becomes active.
    ///
    /// PMW3610 MOTION is active-low. If no motion GPIO is configured, return
    /// immediately and let the caller fall back to regular reads.
